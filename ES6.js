/************************************************************************
                         let, const, var details  
**********************************************************************/
var age = 20;

if (age > 18) {
    const name1 = "salman shah";
    let name2 = "manna bhai";
...
this is main difference between this 
...
// akhane name2 ter vlaue assign kore deyar jonne seta output dibe jodi ami mostan aakta value dei .
...
/* ``atake backtick or caret pora hoye thake 
...
// second bracket dile return deya lage nahole lage na.miltiple line code kora lagle second bracket use kora lagto 
...
const res = add(10, 20);
console.log(res);
// atake easily arrow funtion diye likha jai 
...
console.log(mostan2)
// normal copy korle reference copy hoi .spread operator kore copy korle value copy hoi 
//array theke element copy kora jai easily .ajonne use besi hoi 
...
//akat object er moddhe r akta object thakle tokhon easily access korar jonne  
// bar bar 
